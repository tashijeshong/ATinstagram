...
class SentimentIntensityAnalyzer(object):
    ...
    def scores_of_each_words(self, text):
        ...
        # print(words_and_emoticons) # list of words in the sentence
    ...
    def list_of_lexicon_words(self, text):
        lexicon_words = []
        for i, item in enumerate(text):
            item_lowercase = item.lower()
            if item_lowercase in self.lexicon:
                lexicon_words.append(item)
    ...
    def sentiment_valence(self, valence, sentitext, item, i, sentiments):
        ...
        if item_lowercase in self.lexicon:
            ...
            # print("The word '%s' is in the lexicon list. Starting valence and intensity analysis..." % item)
            ...
            if item_lowercase == "no" and i != len(words_and_emoticons)-1 and words_and_emoticons[i + 1].lower() in self.lexicon:
                ...
                # print("negation word 'no' used before %s: used as negation. setting 'no' as 0.0 valence." % item_lowercase)
                valence = 0.0
            if (i > 0 and words_and_emoticons[i - 1].lower() == "no") \
               ...
               or (i > 2 and words_and_emoticons[i - 3].lower() == "no" and words_and_emoticons[i - 1].lower() in ["or", "nor"] ):
                # print("setting '%s' as negative valence." % item_lowercase)
            ...
            if item.isupper() and is_cap_diff:
                if valence > 0:
                    valence += C_INCR
                    # print("The word '%s' is in ALL CAPS. Intensity rating is increased" % item)
                else:
                    valence -= C_INCR
            
            # print("The word '%s' is not in ALL CAPS. Intensity rating is not increased." % item)
            ...
            # print("The word '%s' is not in the lexicon list." % item)
        sentiments.append(valence)
